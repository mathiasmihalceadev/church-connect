    ...
    ({className, children, ...props}, ref) => {
        ...
        return (
            <div
                ref={ref}
                className={cn(
                    "flex tracking-tight flex-wrap gap-1 text-hyacinth-arbor cursor-pointer font-medium px-1 py-2 border border-input-gray rounded-full bg-background",
                    className
                )}
                {...props}
            >
                {value.map((item, index) => (
                    <Badge
                        key={item}
                        className={cn(
                            "px-1 bg-royal-blue rounded-xl flex items-center gap-1",
                    ...
                    >
                        ...
                        >
                            ...
                            <RemoveIcon className="h-4 w-4 text-white hover:stroke-destructive"/>
                        </button>
                    </Badge>
                ))}
                {children}
    ...
    ({className, value, children, ...props}, ref) => {
        ...
        return (
            <CommandItem
                ...
                className={cn(
                    "rounded-md hover:bg-background-gray cursor-pointer px-2 py-2 text-base transition-colors flex justify-between ",
                    className,
